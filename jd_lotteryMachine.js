...
function updateShareCodes() {
  //let url = 'https://raw.githubusercontent.com/yangtingxiao/QuantumultX/master/scripts/jd/jd_lotteryMachine.js'
  return new Promise(resolve => {
    const options = {
...
function updateShareCodesCDN() {
  // let url = 'https://cdn.jsdelivr.net/gh/yangtingxiao/QuantumultX@master/scripts/jd/jd_lotteryMachine.js'
